...
![img](research/results/img/losses_per_fold_10epochs.png)

From a small training of 100 epochs on naive-aligned data, these losses where computed. The mean CER was 0.7
![img](research/results/img/losses_per_fold_100epochs_naivepad.png)
...
![img](research/results/img/losses_per_fold_100epochs_linfilter_naivepad.png)
...
![img](research/results/img/losses_per_fold_100epochs_aligned.png)
...
![img](research/results/img/losses_per_fold_aligned_ir_sdr.png)
...
![img](research/results/img/losses_per_fold_aligned_ir_sdr_dec.png)
...
![img](research/results/img/losses_per_fold_aligned_ir_spec.png)
...
![img](research/results/img/losses_per_fold_aligned_ir_comb.png)